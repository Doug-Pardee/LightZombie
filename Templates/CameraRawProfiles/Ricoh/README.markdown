# Raw profiles for new Ricoh camera models
...
Here are some Raw Tone Curve files for Ricoh cameras that weren't included
in LightZone 3.9.
...
* Ricoh GXR : custom-created (based on A12 50MM module)
* Ricoh GXR A12 : copy of Ricoh GXR profile
* Ricoh GXR MOUNT A12_VOIGTLANDER CS 35/5MM : copy of Ricoh GXR profile
