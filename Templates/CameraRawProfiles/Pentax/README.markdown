# Raw profiles for new Pentax camera models
...
Here are some Raw Tone Curve files for Pentax cameras that weren't included
in LightZone 3.9.
...
* Pentax K-5: custom-created by AdrianP
